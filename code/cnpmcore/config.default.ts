...
export default (appInfo: EggAppConfig) => {
  ...
  const client = new OSSClient({
    // accessKeyId: 'TD0vGw040OfOPq8Y5zb3',
    // accessKeySecret: 'Y72OFvwozcj3rdh5i4LkD7iYG3KIPtnXXVe6Pnlb',
    // endpoint: 'http://101.201.34.107:9001',
    accessKeyId: 'LTAI5tDr876cjojRTD7KZDhe',
    accessKeySecret: 'O18Kdrnuo09b64PQ5FE3Su336qe5DD',
